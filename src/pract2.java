...
public class pract2
{
    ...
    public int id;
    public int target;
    public static final double lk =  0.1;
    ...
    public static void setPerceptron()
    {
       perceptron = new Neuron()   //initialize perceptron with given weights
       {
           @Override
           public void train(int [] values , int target)   //training function
           {
               ...
               if (guess != target )
               {
                   double deltaWeight = 0;                              // deltaWeight is the change for the weight vector
